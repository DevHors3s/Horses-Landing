...
export default function AboutSection() {
  ...
  // 🔴 IMPORTANTE: Definimos los datos DENTRO del componente para que se actualicen
  const team = [
    {
  ...
  return (
    <section className="relative min-h-screen py-20 px-4 bg-[#0A0F1C] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* PARTE 2: EQUIPO (Ahora traducido dinámicamente) */}
        <div className="mb-32">
          <motion.div 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {team.map((member, index) => (
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-6 min-h-15">
                  {member.bio}
                </p>
